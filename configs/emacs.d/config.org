...
- It helps managing RSS feeds and reading new feed articles.
...
#+BEGIN_SRC emacs-lisp
  (use-package org-roam
    ...
    (setq org-roam-directory "~/Devel/git/notes/roam/")
...
#+BEGIN_SRC emacs-lisp
  (use-package org-journal
    ...
    (setq org-journal-file-format "journal/%Y-%m-%d.org.gpg")
